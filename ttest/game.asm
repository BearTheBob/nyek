...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; width 30 ... height 31
PLAYER1_IMAGES SEGMENT 'FAR DATA'
...
MOV AX, PLAYER1_IMAGES
MOV ES, AX

MOV AX, PLAYER2_IMAGES
MOV ES, AX
...
Draw_car_one       PROC   near  
       ...
       m1:
        MOV AX, SEG CAR_IMAGES1
		MOV DS, AX
		MOV DI, OFFSET img1
		JMP st
       m2:
        MOV AX, SEG CAR_IMAGES2
		MOV DS, AX
		MOV DI, OFFSET img2
		JMP st
       m3:
        MOV AX, SEG CAR_IMAGES3
		MOV DS, AX
		MOV DI, OFFSET img3
		JMP st
       m4:
        MOV AX, SEG CAR_IMAGES4
		MOV DS, AX
		MOV DI, OFFSET img4
		JMP st
       m5:
		MOV AX, SEG CAR_IMAGES5
		MOV DS, AX
		MOV DI, OFFSET img5
		JMP st
       m6:
        MOV AX, SEG CAR_IMAGES6
		MOV DS, AX
		MOV DI, OFFSET img6
		JMP st
       m7:
        MOV AX, SEG CAR_IMAGES7
		MOV DS, AX
		MOV DI, OFFSET img7
		JMP st
       m8:
        MOV AX, SEG CAR_IMAGES8
		MOV DS, AX
		MOV DI, OFFSET img8
		JMP st
...
; Draw Player 1 at index 5,5
	MOV AX, SEG PLAYER1_IMAGES   ; Load image segment
    MOV ES, AX
    MOV DI, OFFSET player1_img

    MOV CX, 30                ; Image width
    MOV DX, 31                ; Image height
    JMP Drawplayer

Drawplayer:
    MOV AH, 0Ch               ; Set pixel function
    MOV AL, ES:[DI]           ; Get pixel color from ES:DI
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Draw Player 2
	MOV AX, SEG PLAYER2_IMAGES   ; Load image segment
    MOV ES, AX
    MOV DI, OFFSET player2_img
